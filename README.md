...
My name is Jean Youn (or you can just call me Jean). I'm a software engineer with experience building web applications using Ruby on Rails, Python, FastAPI, SQLAlchemy, PostgreSQL, MongoDB, JavaScript, TypeScript, React, Redux, Next.js, Jest, Cypress, AWS, and many other tools.


Just last year, I graduated from the full-stack software enginnering curriculum at App Academy, a 16-week, 1000+ hour web development boot camp program with a ~3% acceptance rate. Here, I spent over 100 hours a week honing my coding skills and building projects like Mocdoc. 
